...
# kodów kodów liczbowych tych znaków. Jeśli nie pamiętasz jak przejść listę bez uzywania pętli for, sięgnij do rozdziału List Comprehension
#
...
def save(user_data, encoding_function):
    # wywołaj funkcję write_to_file przekazując zakodowany ciąg znaków
...
user_data = # przekonwertuj słownik na ciąg znaków wykorzystując moduł json

# napisz wyrazenie lambda kodujące kazdy znak z przekonwertowanego ciągu do kodów liczbowych

# wywołaj funkcję save z odpowiednimi parametrami